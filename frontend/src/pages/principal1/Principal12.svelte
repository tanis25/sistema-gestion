<script>
  ...
  let perms = $derived(getPermisos(permisosVal, esAdminVal, 'Principal 1.2'));
  ...
  const datos = [
    { id: 1, nombre: 'Registro Delta', descripcion: 'Descripción del registro delta', estado: 'Activo', fecha: '2026-01-18' },
    { id: 2, nombre: 'Registro Epsilon', descripcion: 'Descripción del registro epsilon', estado: 'Activo', fecha: '2026-02-22' },
    { id: 3, nombre: 'Registro Zeta', descripcion: 'Descripción del registro zeta', estado: 'Inactivo', fecha: '2026-03-14' },
  ];
...
<Layout>
  <Breadcrumb items={[{ label: 'Principal 1' }, { label: 'Principal 1.2' }]} />

  <div class="page-header">
    <div>
      <h1 class="page-title">Principal 1.2</h1>
  ...
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p12nombre">Nombre *</label>
        <input id="p12nombre" type="text" class="form-control" placeholder="Nombre del registro" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p12desc">Descripción</label>
        <textarea id="p12desc" class="form-control" rows="3" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p12estado">Estado</label>
        <select id="p12estado" class="form-control" bind:value={form.estado}>
...
{#if modalEditar && itemSeleccionado && perms.editar}
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p12enombre">Nombre *</label>
        <input id="p12enombre" type="text" class="form-control" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p12edesc">Descripción</label>
        <textarea id="p12edesc" class="form-control" rows="3" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p12eestado">Estado</label>
        <select id="p12eestado" class="form-control" bind:value={form.estado}>
          <option>Activo</option><option>Inactivo</option>
        </select>
      </div>
      <div class="modal-footer">
