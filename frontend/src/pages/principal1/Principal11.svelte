<script>
  ...
  let perms = $derived(getPermisos(permisosVal, esAdminVal, 'Principal 1.1'));
  ...
  const datos = [
    { id: 1, nombre: 'Registro Alpha', descripcion: 'Descripción del registro alpha', estado: 'Activo', fecha: '2026-01-15' },
    { id: 2, nombre: 'Registro Beta', descripcion: 'Descripción del registro beta', estado: 'Activo', fecha: '2026-02-20' },
    { id: 3, nombre: 'Registro Gamma', descripcion: 'Descripción del registro gamma', estado: 'Inactivo', fecha: '2026-03-10' },
  ];
...
<Layout>
  <Breadcrumb items={[{ label: 'Principal 1' }, { label: 'Principal 1.1' }]} />

  <div class="page-header">
    <div>
      <h1 class="page-title">Principal 1.1</h1>
  ...
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p11nombre">Nombre *</label>
        <input id="p11nombre" type="text" class="form-control" placeholder="Nombre del registro" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p11desc">Descripción</label>
        <textarea id="p11desc" class="form-control" rows="3" placeholder="Descripción opcional" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p11estado">Estado</label>
        <select id="p11estado" class="form-control" bind:value={form.estado}>
...
{#if modalEditar && itemSeleccionado && perms.editar}
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p11enombre">Nombre *</label>
        <input id="p11enombre" type="text" class="form-control" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p11edesc">Descripción</label>
        <textarea id="p11edesc" class="form-control" rows="3" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p11eestado">Estado</label>
        <select id="p11eestado" class="form-control" bind:value={form.estado}>
          <option>Activo</option>
          <option>Inactivo</option>
        </select>
      </div>
