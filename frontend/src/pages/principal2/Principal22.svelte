<script>
  ...
  let perms = $derived(getPermisos(permisosVal, esAdminVal, 'Principal 2.2'));
  ...
  const datos = [
    { id: 1, nombre: 'Registro Kappa', descripcion: 'Descripción del registro kappa', estado: 'Activo', fecha: '2026-01-25' },
    { id: 2, nombre: 'Registro Lambda', descripcion: 'Descripción del registro lambda', estado: 'Activo', fecha: '2026-02-28' },
    { id: 3, nombre: 'Registro Mu', descripcion: 'Descripción del registro mu', estado: 'Inactivo', fecha: '2026-03-22' },
  ];
...
<Layout>
  <Breadcrumb items={[{ label: 'Principal 2' }, { label: 'Principal 2.2' }]} />

  <div class="page-header">
    <div>
      <h1 class="page-title">Principal 2.2</h1>
  ...
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p22nombre">Nombre *</label>
        <input id="p22nombre" type="text" class="form-control" placeholder="Nombre del registro" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p22desc">Descripción</label>
        <textarea id="p22desc" class="form-control" rows="3" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p22estado">Estado</label>
        <select id="p22estado" class="form-control" bind:value={form.estado}>
...
{#if modalEditar && itemSeleccionado && perms.editar}
  <div class="modal-overlay">
    <div class="modal">
      ...
      <div class="form-group">
        <label for="p22enombre">Nombre *</label>
        <input id="p22enombre" type="text" class="form-control" bind:value={form.nombre} />
      </div>
      <div class="form-group">
        <label for="p22edesc">Descripción</label>
        <textarea id="p22edesc" class="form-control" rows="3" bind:value={form.descripcion} minlength="50"></textarea>
      </div>
      <div class="form-group">
        <label for="p22eestado">Estado</label>
        <select id="p22eestado" class="form-control" bind:value={form.estado}>
          <option>Activo</option><option>Inactivo</option>
        </select>
      </div>
      <div class="modal-footer">
